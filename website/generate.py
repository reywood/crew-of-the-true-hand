...
Reads source content from the repo root:
  ...
  session notes/fiz/*.md   Session summary notes (Fiz's POV)
...
def load_sessions():
    # Notes live in a per-PC subfolder (session notes/fiz/YYYY-MM-DD.md). Glob
    # one level down so additional PC subfolders are picked up automatically.
